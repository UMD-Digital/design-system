...
describe('Component: umd-element-card', () => {
  const tagName = 'umd-element-card';
  ...
  describe('Registration', () => {
    it('should register the web component', () => {
      ...
      const testElement = document.createElement('umd-element-card');
  ...
  describe('Slots', () => {
    ...
    it('should validate headline slot', () => {
      ...
      element.appendChild(createSlotContent('headline', 'h3', 'Card Title'));
    ...
    it('should accept all allowed heading levels in headline slot', () => {
      ...
      headingLevels.forEach(tag => {
        const { element } = createTestComponent(tagName);
        element.appendChild(createSlotContent('headline', tag, 'Card Heading'));
    ...
    it('should accept optional text slot', () => {
      ...
      element.appendChild(createSlotContent('text', 'p', 'Card content'));
    ...
    it('should accept optional date slot', () => {
      ...
      element.appendChild(createSlotContent('headline', 'h3', 'Title'));
      element.appendChild(createSlotContent('date', 'p', 'December 25, 2023'));
