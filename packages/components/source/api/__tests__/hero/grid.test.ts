...
describe('Component: umd-element-hero-grid', () => {
  ...
  describe('Slots', () => {
    ...
    it('should accept all defined slots', () => {
      ...
      leftColumn.innerHTML = '<img src="test1.jpg" alt="Test 1"><img src="test2.jpg" alt="Test 2">';
      
      const centerColumn = document.createElement('div');
      centerColumn.slot = 'column-center';
      centerColumn.innerHTML = '<img src="test3.jpg" alt="Test 3"><img src="test4.jpg" alt="Test 4">';
      
      const rightColumn = document.createElement('div');
      rightColumn.slot = 'column-right';
      rightColumn.innerHTML = '<img src="test5.jpg" alt="Test 5"><img src="test6.jpg" alt="Test 6">';
    ...
    it('should extract images from left column slot', () => {
      ...
      const leftColumn = document.createElement('div');
      leftColumn.slot = 'column-left';
      leftColumn.innerHTML = '<img src="left1.jpg" alt="Left 1"><img src="left2.jpg" alt="Left 2">';
      element.appendChild(leftColumn);
    ...
    it('should extract images from center column slot', () => {
      ...
      const centerColumn = document.createElement('div');
      centerColumn.slot = 'column-center';
      centerColumn.innerHTML = '<img src="center1.jpg" alt="Center 1"><img src="center2.jpg" alt="Center 2">';
      element.appendChild(centerColumn);
    ...
    it('should extract images from right column slot', () => {
      ...
      const rightColumn = document.createElement('div');
      rightColumn.slot = 'column-right';
      rightColumn.innerHTML = '<img src="right1.jpg" alt="Right 1"><img src="right2.jpg" alt="Right 2">';
      element.appendChild(rightColumn);
    ...
    it('should handle multiple images in each column', () => {
      ...
      const leftColumn = document.createElement('div');
      leftColumn.slot = 'column-left';
      leftColumn.innerHTML = '<img src="l1.jpg"><img src="l2.jpg"><img src="l3.jpg">';
      
      const centerColumn = document.createElement('div');
      centerColumn.slot = 'column-center';
      centerColumn.innerHTML = '<img src="c1.jpg"><img src="c2.jpg"><img src="c3.jpg"><img src="c4.jpg">';
  ...
  describe('Attributes', () => {
    ...
    it('should not have configuration attributes', () => {
      ...
      expect(Object.keys(attributes).filter(key => key.startsWith('data-')).length).toBe(0);
    });
  });
