 ...
 */
export function isAllowedElement(element: Element, allowedElements: string[]): boolean {
 ...
 */
export function getComponentAttributes(element: HTMLElement): Record<string, string> {
 ...
 */
export function validateComponentLifecycle(
  element: any
): { hasConnectedCallback: boolean; hasDisconnectedCallback: boolean; hasAttributeChangedCallback: boolean } {
  return {
    ...
    hasAttributeChangedCallback: typeof element.attributeChangedCallback === 'function',
  };
}