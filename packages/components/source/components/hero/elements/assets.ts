...
const { ELEMENT_NAME, TYPE_MINIMAL } = VARIABLES;
const {
  IS_TYPE_DEFAULT,
  IS_TYPE_STACKED,
  IS_TYPE_OVERLAY,
...
const StackDefaultOverwrite = `
  @container ${ELEMENT_NAME} (max-width: ${TABLET - 1}px) {
    .${HERO_CONTAINER}${IS_TYPE_DEFAULT} .${HERO_IMAGE} {
      aspect-ratio: 16 / 9;
    }
  }
  ...
  @container ${ELEMENT_NAME} (min-width: ${TABLET}px) {
    .${HERO_CONTAINER}${IS_TYPE_DEFAULT} .${HERO_IMAGE}:before {
      content: "";
      position: absolute;
      top: 0;
      left: 0;
  ...
  .${HERO_CONTAINER}${IS_TYPE_DEFAULT} .${HERO_IMAGE} img,
  .${HERO_CONTAINER}${IS_TYPE_DEFAULT} .${HERO_IMAGE} video {
    object-fit: cover;
...
const LogoTypeOverwrite = `
  .${HERO_CONTAINER}${IS_TYPE_LOGO} .${HERO_IMAGE} {
    text-align: center;
    display: flex;
  ...
  .${HERO_CONTAINER}${IS_TYPE_LOGO} .${HERO_IMAGE} img {
    max-width: 80%;
    margin-left: auto;
    margin-right: auto;
  }
...
const StackTypeOverwrite = `
  .${HERO_CONTAINER}${IS_TYPE_STACKED} .${HERO_IMAGE} img,
  .${HERO_CONTAINER}${IS_TYPE_STACKED} .${HERO_IMAGE} video {
    object-fit: cover;
    object-position: center;
    height: 100%;
    width: 100%;
...
const OverlayTypeOverwrite = `
  @container ${ELEMENT_NAME} (min-width: ${TABLET}px) {
    .${HERO_CONTAINER}${IS_TYPE_OVERLAY} .${HERO_IMAGE} {
      position: absolute;
      width: 50%;
  ...
  @container ${ELEMENT_NAME} (min-width: ${TABLET}px) {
    .${HERO_CONTAINER}${IS_TYPE_OVERLAY} .${HERO_IMAGE}:before {
      content: '';
      position: absolute;
      left: 0;
      top: 0;
  ...
  .${HERO_CONTAINER}${IS_TYPE_OVERLAY} .${HERO_IMAGE} img,
  .${HERO_CONTAINER}${IS_TYPE_OVERLAY} .${HERO_IMAGE} video {
    object-fit: cover;
    object-position: center;
    height: 100%;
    width: 100%;
...
const MinimalTypeOverwrite = `
  @container ${ELEMENT_NAME} (min-width: ${TABLET}px) {
    .${HERO_CONTAINER}${IS_TYPE_MINIMAL} .${HERO_IMAGE} {
      position: absolute;
      right: 0;
      top: 0;
      width: 50%;
  ...
  @container ${ELEMENT_NAME} (min-width: ${TABLET}px) {
    .${HERO_CONTAINER}${IS_TYPE_MINIMAL} .${HERO_IMAGE} img {
      object-fit: cover;
      object-position: center;
      height: 100%;
      width: 100%;
...
export const CreateAsset = ({ element }: { element: UMDHeroElement }) => {
