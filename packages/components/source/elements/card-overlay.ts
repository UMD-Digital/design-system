...
// prettier-ignore
export const CtaIconContainerStyles = `
...
// prettier-ignore
export const STYLES_OVERLAY_CARD = `
...
export const MakeCtaIconContainer = ({ ctaIcon }: TypeCardOverlayElement) => {
...
export const CreateCardOverlayElement = (element: TypeCardOverlayElement) => {
