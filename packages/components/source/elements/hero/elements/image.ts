...
const ELEMENT_IMAGE_CONTINATER = 'hero-image-container';

// prettier-ignore
const STYLES_HERO_ELEMENT_IMAGE_CONTAINER = `
  ${LayoutImage.Styles}
...
const CreateImageContainerElement = (element: TypeImageContainerProps) => {
  const {
    imageRef,
    videoRef,
    isTypeMinimal = false,
