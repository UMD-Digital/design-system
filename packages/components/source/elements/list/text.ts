...
export const LIST_EYEBROW_WRAPPER = 'umd-list-eyebrow-wrapper';
export const LIST_HEADLINE_WRAPPER = 'umd-list-headline-wrapper';
export const LIST_TEXT_WRAPPER = 'umd-list-text-wrapper';
export const LIST_DATE_WRAPPER = 'umd-list-date-wrapper';
export const LIST_ACTIONS_WRAPPER = 'umd-list-actions-wrapper';
...
const DarkThemeStyles = `
  ...
  ${LIST_DATE_WRAPPER} .${LIST_TEXT_WRAPPER} {
    color: ${Colors.white};
  }
`
