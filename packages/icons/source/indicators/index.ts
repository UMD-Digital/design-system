 ...
 * Indicator Icons
 *
 * Icons for alerts, notifications, and status indicators
 *
 * @example
 * ```typescript
 * import { alert as iconAlert } from '@universityofmaryland/web-icons-library/indicators';
 * import { warning as iconWarning } from '@universityofmaryland/web-icons-library/indicators';
 * ```
 */

export const alert = `<svg title="exclamation icon" aria-hidden="true" id="icon_exclamation" width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="20" cy="20" r="20" /><rect x="18" y="11" width="4" height="13" fill="white"/><rect width="4" height="4" transform="matrix(1 0 0 -1 18 30)" fill="white"/></svg>`;
