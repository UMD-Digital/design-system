 ...
 * ```
 * @deprecated Use 'umd-layout-background-quarter-light' instead of 'umd-layout-background-quater-color'.
 * @since 1.8.0
 */
 ...
 * ```
 * @deprecated Use 'umd-layout-background-quarter-dark' instead of 'umd-layout-background-quater-color'.
 * @since 1.8.0
 */
