import { animationLinkSpan } from '../../animation/animationLinkSpan';

describe('animationLinkSpan', () => {
  ...
  describe('edge cases', () => {
    ...
    it('should return early if element is a slot', () => {
      ...
      animationLinkSpan({ element: slot });
    ...
    it('should return early if no link found', () => {
      ...
      expect(() => animationLinkSpan({ element })).not.toThrow();
    });
  ...
  describe('error conditions', () => {
    it('should handle null element', () => {
      expect(() => animationLinkSpan({ element: null as any })).toThrow();
    });

    it('should handle undefined element', () => {
      expect(() => animationLinkSpan({ element: undefined as any })).toThrow();
    });
    ...
    it('should handle element not in DOM', () => {
      ...
      expect(() => animationLinkSpan({ element: detachedDiv })).not.toThrow();
    });
  });
});