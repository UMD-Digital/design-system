import { loadGridAnimationObserver } from '../../animation/loadGridAnimationObserver';

describe('loadGridAnimationObserver', () => {
  ...
  describe('edge cases', () => {
    ...
    it('should handle empty grid containers', () => {
      ...
      expect(() => loadGridAnimationObserver()).not.toThrow();
    });
  ...
  describe('error conditions', () => {
    it('should handle missing window.matchMedia gracefully', () => {
      ...
      expect(() => loadGridAnimationObserver()).toThrow();
