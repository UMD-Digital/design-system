import { createVisualFormattedDate } from '../../date/createVisualFormattedDate';

describe('createVisualFormattedDate', () => {
  describe('happy path', () => {
    it('should format date with all properties', () => {
      const date = new Date('2025-09-29T14:30:00');
      const result = createVisualFormattedDate(date);
  ...
  describe('edge cases', () => {
    ...
    it('should handle different years', () => {
      ...
      const result1 = createVisualFormattedDate(date1);
      const result2 = createVisualFormattedDate(date2);
    ...
    it('should handle different weekdays', () => {
      ...
      const resultSunday = createVisualFormattedDate(sunday);
      const resultMonday = createVisualFormattedDate(monday);
  ...
  describe('error conditions', () => {
    it('should handle invalid date', () => {
      ...
      const result = createVisualFormattedDate(invalidDate);
    ...
    it('should handle null date', () => {
      expect(() => createVisualFormattedDate(null as any)).toThrow();
    });

    it('should handle undefined date', () => {
      expect(() => createVisualFormattedDate(undefined as any)).toThrow();
    });
  });
  ...
  describe('consistency', () => {
    it('should be consistent across multiple calls', () => {
      const date = new Date('2025-09-29T14:30:00');
      const result1 = createVisualFormattedDate(date);
      const result2 = createVisualFormattedDate(date);
