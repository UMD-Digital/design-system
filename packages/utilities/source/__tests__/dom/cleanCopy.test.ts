import { cleanCopy } from '../../dom/cleanCopy';
...
describe('cleanCopy', () => {
  describe('happy path', () => {
    it('should preserve href attribute', () => {
      ...
      const result = cleanCopy({ element: link });
    ...
    it('should remove all attributes except href', () => {
      ...
      const result = cleanCopy({ element });
    ...
    it('should deep clone element with children', () => {
      ...
      const result = cleanCopy({ element: parent });
    ...
    it('should preserve href on anchor elements', () => {
      ...
      const result = cleanCopy({ element: anchor });
  ...
  describe('edge cases', () => {
    ...
    it('should handle element without href attribute', () => {
      ...
      const result = cleanCopy({ element: div });
    ...
    it('should handle nested elements with attributes', () => {
      ...
      expect(result.getAttribute('id')).toBeNull();
      // Note: cleanCopy only cleans the top-level element, not children
    ...
    it('should handle boolean attributes', () => {
      ...
      const result = cleanCopy({ element: button });
  ...
  describe('different element types', () => {
    ...
    it('should work with input elements', () => {
      ...
      const result = cleanCopy({ element: input });
    ...
    it('should work with span elements', () => {
      ...
      const result = cleanCopy({ element: span });
  ...
  describe('error conditions', () => {
    it('should handle null element', () => {
      expect(() => cleanCopy({ element: null as any })).toThrow();
    });

    it('should handle undefined element', () => {
      expect(() => cleanCopy({ element: undefined as any })).toThrow();
    });
  });
