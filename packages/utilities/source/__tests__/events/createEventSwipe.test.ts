import { createEventSwipe } from '../../events/createEventSwipe';

describe('createEventSwipe', () => {
  ...
  describe('happy path', () => {
    it('should detect swipe right', () => {
      createEventSwipe({ container, callback: mockCallback });
  ...
  describe('error conditions', () => {
    it('should handle null container', () => {
      expect(() =>
        createEventSwipe({ container: null as any, callback: mockCallback }),
      ).toThrow();
    });
