import { createContainerQuery } from '../../styles/createContainerQuery';
...
describe('createContainerQuery', () => {
  describe('happy path', () => {
    it('should create max-width query by default', () => {
      ...
      const result = createContainerQuery('max-width', 767, styles);
    ...
    it('should create min-width query', () => {
      ...
      const result = createContainerQuery('min-width', 768, styles);
    ...
    it('should include px units in media query', () => {
      ...
      const result = createContainerQuery('min-width', 1024, styles);
  ...
  describe('edge cases', () => {
    it('should handle zero breakpoint', () => {
      ...
      const result = createContainerQuery('min-width', 0, styles);
    ...
    it('should handle negative breakpoint', () => {
      ...
      const result = createContainerQuery('min-width', -100, styles);
    ...
    it('should handle very large breakpoint', () => {
      ...
      const result = createContainerQuery('min-width', 99999, styles);

      expect(result).toHaveProperty('@media (min-width: 99999px)');
    });

    it('should handle empty styles object', () => {
      const result = createContainerQuery('min-width', 768, {});
    ...
    it('should handle fractional breakpoints', () => {
      ...
      const result = createContainerQuery('min-width', 768.5, styles);
  ...
  describe('common breakpoints', () => {
    ...
    it('should handle large desktop breakpoint (min-width: 1440px)', () => {
      ...
      const result = createContainerQuery('min-width', 1440, styles);
  ...
  describe('immutability', () => {
    it('should not modify input styles object', () => {
      ...
      createContainerQuery('min-width', 768, styles);
  ...
  describe('comparison types', () => {
    ...
    it('should default to max-width when comparison not provided', () => {
      ...
      const result = createContainerQuery(comparison as any, 767, styles);
  ...
  describe('use cases', () => {
    it('should support responsive font sizes', () => {
      const mobileStyles = createContainerQuery('max-width', 767, {
        fontSize: '14px',
      });

      const tabletStyles = createContainerQuery('min-width', 768, {
        fontSize: '16px',
      });
    ...
    it('should support responsive spacing', () => {
      const result = createContainerQuery('min-width', 1024, {
        padding: '3rem',
        margin: '2rem auto',
      });
