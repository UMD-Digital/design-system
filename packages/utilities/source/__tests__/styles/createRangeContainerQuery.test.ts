import { createRangeContainerQuery } from '../../styles/createRangeContainerQuery';

describe('createRangeContainerQuery', () => {
  describe('happy path', () => {
    it('should create range query with min and max', () => {
      const styles = { fontSize: '18px' };

      const result = createRangeContainerQuery(768, 1023, styles);
  ...
  describe('edge cases', () => {
    it('should handle zero as min breakpoint', () => {
      ...
      const result = createRangeContainerQuery(0, 767, styles);
    ...
    it('should handle zero as max breakpoint', () => {
      ...
      const result = createRangeContainerQuery(-100, 0, styles);
    ...
    it('should handle negative breakpoints', () => {
      ...
      const result = createRangeContainerQuery(-200, -100, styles);
    ...
    it('should handle very large breakpoints', () => {
      ...
      const result = createRangeContainerQuery(5000, 10000, styles);
    ...
    it('should handle min greater than max', () => {
      ...
      const result = createRangeContainerQuery(1024, 768, styles);
    ...
    it('should handle min equal to max', () => {
      ...
      const result = createRangeContainerQuery(768, 768, styles);
    ...
    it('should handle empty styles object', () => {
      const result = createRangeContainerQuery(768, 1023, {});
    ...
    it('should handle fractional breakpoints', () => {
      ...
      const result = createRangeContainerQuery(768.5, 1023.75, styles);
  ...
  describe('common tablet range', () => {
    ...
    it('should handle portrait tablet range', () => {
      ...
      const result = createRangeContainerQuery(768, 991, styles);
    ...
    it('should handle landscape tablet range', () => {
      ...
      const result = createRangeContainerQuery(992, 1199, styles);
  ...
  describe('immutability', () => {
    it('should not modify input styles object', () => {
      ...
      createRangeContainerQuery(768, 1023, styles);
  ...
  describe('comparison with createContainerQuery', () => {
    it('should create more specific query than createContainerQuery', () => {
      const styles = { fontSize: '16px' };
    ...
    it('should limit styles to specific viewport range', () => {
      const tabletOnlyStyles = createRangeContainerQuery(768, 1023, {
        columns: 2,
      });
