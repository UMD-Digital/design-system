 ...
 * @example
 * ```typescript
 * const dateString = createDateCompareString(new Date('2025-09-29T14:30:00'));
 * // { palindromeTruncated: '2025-09-29' }
 *
 * // Useful for comparisons
 * const date1 = createDateCompareString(new Date('2025-09-29'));
 * const date2 = createDateCompareString(new Date('2025-09-30'));
